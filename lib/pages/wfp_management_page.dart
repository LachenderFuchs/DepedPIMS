...
class _HintLabel extends StatelessWidget {
  ...
  const _HintLabel(this.text, {required this.hint});
...
class WFPManagementPageState extends State<WFPManagementPage> {
  static const double _tagCellMaxWidth = 96;
  static const double _dueDateCellMaxWidth = 118;
    ...
    filtered.sort((a, b) {
      ...
      switch (_sortColumnIndex) {
        ...
        case 3:
          ...
          break;
        case 4:
          cmp = a.viewSection.compareTo(b.viewSection);
          break;
        case 5:
  ...
  void openWFPById(String id) {
    final index = widget.appState.wfpEntries.indexWhere(
      (item) => item.id == id,
    );
    if (index == -1) return;
    final entry = widget.appState.wfpEntries[index];
  ...
  Future<void> _pickApprovedDate() async {
    ...
    if (picked != null) {
      setState(() => _approvedDate = picked.toIso8601String().substring(0, 10));
    }
  }
  ...
  Future<void> _submitEntry() async {
    ...
    final validationError = RecordValidator.validateWfp(
      title: _title.text,
      targetSize: _targetSize.text,
      indicator: _indicator.text,
      amount: parsedAmount,
      year: _selectedYear,
      fundType: _fundType,
      ...
      dueDate: _dueDate,
      existingEntries: widget.appState.wfpEntries,
      editingId: _editingEntry?.id,
    );
  ...
  Future<void> _confirmDelete(WFPEntry entry) async {
    final activityCount = await widget.appState.getActivityCountForWFP(
      entry.id,
    );
    if (!mounted) return;
            ...
            if (activityCount > 0)
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(6),
                  border: Border.all(
                    color: AppColors.tint(AppColors.warning, 0.28),
                  ),
                ),
                child: Row(
                  children: [
              ...
              Text(
                'This entry has no linked activities. It will be moved to the Recycle Bin.',
  ...
  Widget _buildCompactChip({
    ...
    double maxWidth = _tagCellMaxWidth,
  }) {
    return Tooltip(
      message: tooltip,
  ...
  Widget _buildDueDateCell(
    WFPEntry entry, {
    double maxWidth = _dueDateCellMaxWidth,
  }) {
    ...
    final dueColor = daysUntil != null && daysUntil < 0
        ? AppColors.danger
        : AppColors.textPrimary;
    final dueMessage = daysUntil == null
        ? 'Due: ${entry.dueDate}'
        : daysUntil < 0
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Create, manage, and track Work and Financial Plan entries.',
                      style: TextStyle(
                        color: AppColors.textSecondary,
                        fontSize: 13,
                      ),
                            ...
                            LayoutBuilder(
                              builder: (context, c) {
                                ...
                                final titleField = _TooltipField(
                                  tooltip:
                                      'Enter the full official name of the program or project.\nExample: "Special Education Fund – Training"',
                                  child: TextField(
                                    controller: _title,
                                    decoration: InputDecoration(
                                      ...
                                      helperText:
                                          'Required. Must be unique across all WFP entries.',
                                      ...
                                      suffixIcon: Tooltip(
                                        message:
                                            'The official program or project title as it appears in the approved WFP document.',
                                        child: Icon(
                                          Icons.help_outline_rounded,
                                          size: 16,
                                          color: Colors.grey.shade400,
                                ...
                                final targetSizeField = _TooltipField(
                                  tooltip:
                                      'Specify the number or scope of beneficiaries/outputs.\nExamples: "500 Teachers", "3 Schools", "1 Batch"',
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      helperText:
                                          'Number of beneficiaries or output units.',
                                      prefixIcon: const Icon(
                                      ...
                                      suffixIcon: Tooltip(
                                        message:
                                            'How many people or units this program targets. Leave blank if not applicable.',
                                        child: Icon(
                                          Icons.help_outline_rounded,
                                          size: 16,
                                          color: Colors.grey.shade400,
                                ...
                                final indicatorField = _TooltipField(
                                  tooltip:
                                      'Describe the measurable outcome or success indicator.\nExample: "80% of trainees pass post-assessment"',
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      helperText:
                                          'Performance indicator or relevant details.',
                                      prefixIcon: const Icon(
                                      ...
                                      suffixIcon: Tooltip(
                                        message:
                                            'The performance indicator used to measure accomplishment of this program.',
                                        child: Icon(
                                          Icons.help_outline_rounded,
                                          size: 16,
                                          color: Colors.grey.shade400,
                                ...
                                final amountField = _TooltipField(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: '0.00',
                                      helperText:
                                          'Total approved budget in Philippine Peso.',
                                      prefixText: '₱ ',
                                      prefixIcon: const Icon(
                                      ...
                                      suffixIcon: Tooltip(
                                        message:
                                            'The total allotment or appropriation for this WFP entry. Required.',
                                        child: Icon(
                                          Icons.help_outline_rounded,
                                          size: 16,
                                          color: Colors.grey.shade400,
                            ...
                            LayoutBuilder(
                              builder: (context, c) {
                                final approvalDd = _TooltipField(
                                  tooltip:
                                      'Set the current approval lifecycle status of this WFP entry.\n'
                                ...
                                final dueDateField = Tooltip(
                                  message:
                                      'Tap to set the deadline or end date for this WFP entry.\n'
                    ...
                    LayoutBuilder(
                      builder: (context, c) {
                        final searchField = Tooltip(
                          message:
                              'Search across WFP ID, title, fund type, year, target size, indicator, section, and approval status.\nPress Enter or type to filter results instantly.',
                          preferBelow: false,
                          waitDuration: const Duration(milliseconds: 500),
                          decoration: BoxDecoration(
                            color: AppColors.textPrimary,
                          ...
                          child: TextField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              hintText:
                                  'Title, ID, fund type, year, section, approval status…',
                            ),
                        ...
                        final paginationControls = Row(
                          ...
                          children: [
                            ...
                            Tooltip(
                              message:
                                  'Choose how many WFP entries are shown per page in the table below.',
                              preferBelow: false,
                              waitDuration: const Duration(milliseconds: 400),
                              decoration: BoxDecoration(
                                color: AppColors.textPrimary,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Tooltip(
                          message:
                              'Current zoom level (${(_zoom / _baselineZoom * 100).round()}%). Click the reset button to restore default.',
                          child: Text(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Builder(
                              builder: (ctx) {
                                ...
                                final tableWidth = useExpandedLayout
                                    ? baseWidth * _zoom
                                    : baseWidth;
                                ...
                                final sectionWidth = _responsiveColumnWidth(
                                  tableWidth,
                                  fraction: 0.085,
                                  min: 92,
                                  max: 124,
                                ...
                                final columns = <DataColumn2>[
                                  DataColumn2(
                                    label: const Tooltip(
                                      message:
                                          'Unique system-generated identifier for each WFP entry.\nFormat: WFP-YYYY-NNNN',
                                      child: _HintLabel(
                                        'WFP ID',
                                        hint:
                                  ...
                                  DataColumn2(
                                    label: const Tooltip(
                                      message:
                                          'The official program or project title as recorded in the WFP.',
                                      child: _HintLabel(
                                        'Title',
                                        hint: 'Program or project title',
                                      ),
                                    ),
                                    size: ColumnSize.L,
                                    onSort: _onSort,
                                  ...
                                  DataColumn2(
                                    label: const Tooltip(
                                      message:
                                          'Number or scope of beneficiaries/outputs targeted by this program.',
                                      child: _HintLabel(
                                        'Target Size',
                                        hint: 'Beneficiaries or output count',
                                      ),
                                    ),
                                    size: ColumnSize.M,
                                    onSort: _onSort,
                                  ...
                                  DataColumn2(
                                    label: const Tooltip(
                                      message:
                                          'Budget fund source classification for this WFP entry.\nHover over a value in the table for its full name.',
                                      child: _HintLabel(
                                        'Fund Type',
                                        hint: 'Budget fund source',
                                      ),
                                    ),
                                  ...
                                  DataColumn2(
                                    label: const Tooltip(
                                      message:
                                          'The division or section responsible for implementing this program.',
                                      child: _HintLabel(
                                        'Section',
                                        hint: 'Implementing division',
                                      ),
                                    ),
                                  ...
                                  DataColumn2(
                                    label: const Tooltip(
                                      message:
                                          'Calendar year this WFP entry was planned for.',
                                      child: _HintLabel(
                                        'Year',
                                        hint: 'Planning year',
                                      ),
                                  ...
                                  DataColumn2(
                                    label: const Tooltip(
                                      message:
                                          'Total approved budget allotment for this WFP entry in Philippine Peso (₱).',
                                      child: _HintLabel(
                                        'Amount',
                                        hint: 'Approved budget in ₱',
                                      ),
                                    ),
                                    size: ColumnSize.M,
                                    numeric: true,
                                  ...
                                  DataColumn2(
                                    label: const Tooltip(
                                      ...
                                      child: _HintLabel(
                                        'Approval',
                                        hint: 'Approval lifecycle status',
                                      ),
                                    ),
                                  ...
                                  DataColumn2(
                                    label: const Tooltip(
                                      message:
                                          'Deadline or end date for this WFP entry.\nEntries due within the warning window are flagged with a ⚠ icon.',
                                      child: _HintLabel(
                                        'Due Date',
                                        hint: 'Program deadline or end date',
                                      ),
                                    ),
                                ...
                                List<DataRow2> buildRows() {
                                  return _pagedRows.asMap().entries.map((
                                    entry,
                                  ) {
                                    final i = entry.key;
                                    final e = entry.value;
                                    ...
                                    return DataRow2(
                                      ...
                                      cells: [
                                        ...
                                        DataCell(
                                          Tooltip(
                                            message:
                                                'Total budget: ${CurrencyFormatter.format(e.amount)}',
                                            child: Text(
                                        ...
                                        DataCell(
                                          e.dueDate == null
                                              ? Tooltip(
                                                  message:
                                                      'No due date set for this entry.',
                                                  child: Text(
                                                    '—',
                                                    style: TextStyle(
                                                      color:
                                        ...
                                        DataCell(
                                          Row(
                                            ...
                                            children: [
                                              Tooltip(
                                                message:
                                                    'Edit this WFP entry — loads its data into the form above.',
                                                child: IconButton(
                                                  icon: const Icon(
                                                    Icons.edit,
                                                    size: 18,
                                                  ...
                                                  onPressed: () =>
                                                      _loadEntryIntoForm(e),
                                                ),
                                              ),
                                              Tooltip(
                                                message:
                                                    'Move this WFP entry to the Recycle Bin.\nLinked budget activities will also be removed.',
                                                child: IconButton(
                                                  icon: Icon(
                                                    Icons.delete,
                                                    size: 18,
