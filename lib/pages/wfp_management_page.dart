    ...
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        return Padding(
          ...
          // CustomScrollView lets the top content scroll naturally while
          // SliverFillRemaining gives the table all remaining bounded space.
          child: CustomScrollView(
            slivers: [

              // ── All content above the table ────────────────────────────
              SliverToBoxAdapter(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                          ...
                          children: [
                            ...
                            LayoutBuilder(builder: (context, c) {
                              ...
                              if (narrow) {
                                return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                                  TextField(controller: _title, decoration: const InputDecoration(labelText: 'Program Title *')),
                                  const SizedBox(height: 10),
                                  TextField(controller: _targetSize, decoration: const InputDecoration(labelText: 'Target Size')),
                                  const SizedBox(height: 10),
                                  TextField(controller: _indicator, decoration: const InputDecoration(labelText: 'Indicator / Details')),
                                ]);
                              }
                              return Row(children: [
                                Expanded(flex: 3, child: TextField(controller: _title, decoration: const InputDecoration(labelText: 'Program Title *'))),
                                const SizedBox(width: 12),
                                Expanded(flex: 2, child: TextField(controller: _targetSize, decoration: const InputDecoration(labelText: 'Target Size'))),
                                const SizedBox(width: 12),
                                Expanded(flex: 2, child: TextField(controller: _indicator, decoration: const InputDecoration(labelText: 'Indicator / Details'))),
                              ]);
                            }),
                            ...
                            LayoutBuilder(builder: (context, c) {
                              ...
                              final fundDd = DropdownButtonFormField<String>(
                                ...
                                items: _fundTypes.map((f) => DropdownMenuItem(value: f, child: Text(f))).toList(),
                            ...
                            LayoutBuilder(builder: (context, c) {
                              ...
                              final approvedDateField = InkWell(
                                ...
                                child: InputDecorator(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      color: _approvalStatus == 'Approved' ? Colors.black87 : Colors.grey.shade400,
                                      fontSize: 14,
                                    ),
                                  ),
                                ),
                              ...
                              if (c.maxWidth < 600) {
                                return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                                  ...
                                  Row(children: [Expanded(child: approvedDateField), const SizedBox(width: 12), Expanded(child: dueDateField)]),
                                ]);
                              }
                              return Row(children: [
              ...
              // ── Table + pagination fill remaining space ─────────────────
              SliverFillRemaining(
                hasScrollBody: true,
                child: Column(
                  children: [
                            ...
                            cells: [
                              DataCell(Row(
                                children: [
                                  if (isPending)
                                    Container(
                                      width: 3, height: 28, margin: const EdgeInsets.only(right: 6),
                                      decoration: BoxDecoration(
                              ...
                              DataCell(Container(
                                ...
                                child: Text(
                                  e.approvalStatus,
                                  style: TextStyle(fontSize: 11, color: approvalClr, fontWeight: FontWeight.w600),
                                ),
                              )),
