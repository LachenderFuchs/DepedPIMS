...
class _BudgetOverviewPageState extends State<BudgetOverviewPage> {
  ...
  final _wfpSearch      = TextEditingController(); // WFP search

  String _status = 'Not Started';
  String? _targetDate;
  BudgetActivity? _editingActivity;

  // ── Activity table sort / pagination ──────────────────────────────────────
  ...
  // Fixed height for the activity table — avoids SliverFillRemaining overflow
  ...
  // ─── Select WFP + scroll to activity section ──────────────────────────────
  ...
  Future<void> _submitActivity() async {
    ...
    if (!selectedWFP.isApproved) {
      _showSnack(
        'Cannot add activities — this WFP entry is "${selectedWFP.approvalStatus}". '
        'Change approval status to Approved first.',
        isError: true,
      );
      return;
    }
    ...
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        return Padding(
          ...
          // Use a plain SingleChildScrollView — no SliverFillRemaining,
          // so scrolling up never causes a bottom overflow.
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                          ...
                          final searchField = SizedBox(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: 'Search by ID, title, fund type, year, approval…',
                      ...
                      SizedBox(
                        ...
                        child: allWFP.isEmpty
                            ...
                            : wfpEntries.isEmpty
                                ? Center(
                                    child: Text('No results for "${_wfpSearch.text}"',
                                      style: TextStyle(color: Colors.grey.shade400, fontSize: 13)),
                                  )
                                : DataTable2(
                                    minWidth: 900,
                                    ...
                                    rows: wfpEntries.asMap().entries.map((entry) {
                                      ...
                                      return DataRow2(
                                        ...
                                        cells: [
                                          ...
                                          // Title with selected accent bar
                ...
                if (selectedWFP != null) ...[
                  ...
                  // ── Activities table — fixed height, no SliverFillRemaining ──
                  SizedBox(
  ...
  Widget _buildSummaryHeader() {
    ...
    return Row(children: [
      _summaryTile('Current Status', overallStatus,
      ...
      _summaryTile('Total AR Balance', CurrencyFormatter.format(s.totalBalance),
        color: s.totalBalance >= 0 ? Colors.green.shade700 : Colors.red.shade700,
        bold: true),
    ]);
  }
    ...
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: Colors.grey.shade200),
          boxShadow: [BoxShadow(
            color: Colors.grey.shade100, blurRadius: 4, offset: const Offset(0, 2))],
        ),
      ...
      child: Row(
        children: [
          Text('Showing $start–$end of $totalItems entries',
            style: TextStyle(fontSize: 13, color: Colors.grey.shade600)),
          const Spacer(),
          IconButton(icon: const Icon(Icons.first_page), tooltip: 'First page', iconSize: 20,
            onPressed: currentPage > 0 ? () => onPageChanged(0) : null),
          IconButton(icon: const Icon(Icons.chevron_left), tooltip: 'Previous page', iconSize: 20,
          ...
          IconButton(icon: const Icon(Icons.chevron_right), tooltip: 'Next page', iconSize: 20,
            onPressed: currentPage < totalPages - 1
                ? () => onPageChanged(currentPage + 1) : null),
          IconButton(icon: const Icon(Icons.last_page), tooltip: 'Last page', iconSize: 20,
            onPressed: currentPage < totalPages - 1
                ? () => onPageChanged(totalPages - 1) : null),
        ],
      ),
    );
  }
